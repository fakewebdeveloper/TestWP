...
if(!class_exists('DR_Appointment'))
{
	class DR_Appointment
	{
		function __construct()
		{
			...
			//register_activation_hook(__FILE__, array('DR_Appointment', 'activation'));
			//register_deactivation_hook(__FILE__, array('DR_Appointment', 'deactivation'));
			//register_uninstall_hook(__FILE__, array('DR_Appointment', 'uninstall'));
			
			//add_action('admin_menu', array(&$this, 'admin_menu'), 27);
			require_once(PLUG_DIR . "/appointments.php");
		}
